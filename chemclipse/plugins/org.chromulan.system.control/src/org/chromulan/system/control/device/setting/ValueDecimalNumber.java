...
public abstract class ValueDecimalNumber<Num extends Number> extends ValueNumer<Num> implements IValueDecimalNumber<Num>{
	...
	public ValueDecimalNumber(IDeviceSetting device, String name, Num defValue, boolean isChangeable, Num min, Num max) {
