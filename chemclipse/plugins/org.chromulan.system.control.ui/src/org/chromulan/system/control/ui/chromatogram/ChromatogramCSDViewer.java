...
public class ChromatogramCSDViewer {
	...
	private IChromatogramCSDAcquisition chromatogramAcquisition;
	private ChromatogramCSDOverviewUI chromatogramOverView;
	@Inject
	private MPart part;
	private RedrawChromatogram redrawChromatogram;

	public ChromatogramCSDViewer() {
	...
	public void createPartControl(Composite parent) {
		...
		chromatogramAcquisition = (IChromatogramCSDAcquisition)part.getObject();
		redrawChromatogram(autoRedraw);
		chromatogramOverView = new ChromatogramCSDOverviewUI(parent, SWT.NONE);
