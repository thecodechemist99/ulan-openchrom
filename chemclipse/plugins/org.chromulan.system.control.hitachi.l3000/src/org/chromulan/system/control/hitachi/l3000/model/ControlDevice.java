...
public class ControlDevice implements IControlDevice {
	...
	public final static String PROPERTY_START_ON_DATA_INPUT = "autoStartRecieveData";
	public final static String PROPERTY_STOP_ON_DATA_INPUT = "autoStopRecieveData";
	...
	public static final String SETTING_START_ON_DATA_INPUT = "start on data input";
	public static final String SETTING_STOP_ON_DATA_INPUT = "stop on data input";
	...
	private boolean autoStartRecieveData;
	private boolean autoStopRecieveData;
	...
	public void addDataRecieveListener(IDataRecieveListener dataRecieveListener) {

		dataReceive.addDataRecieveListener(dataRecieveListener);
	}
	...
	public void addStopDataRecieveListener(IDataStopRecieveListener dataStopRecieveListener) {

		dataReceive.addStopDataRecieveListener(dataStopRecieveListener);
	}
	...
	public boolean isAutoStartRecieveData() {

		return autoStartRecieveData;
	}

	public boolean isAutoStopRecieveData() {

		return autoStopRecieveData;
	}
	...
	public void removeDataRecieveListener(IDataRecieveListener dataRecieveListener) {

		dataReceive.removeDataRecieveListener(dataRecieveListener);
	}
	...
	public void removeStopDataRecieveListener(IDataStopRecieveListener dataStopRecieveListener) {

		dataReceive.removeStopDataRecieveListener(dataStopRecieveListener);
	}
	...
	public boolean sendWaveLenghtRange() throws IOException {
		...
		return serialPort.sendWaveLenghtRange(wavelenghtRangeFrom, wavelenghtRangeTo);
	}
	...
	public void setAutoStartRecieveData(boolean autoStartRecieveData) {

		propertyChangeSupport.firePropertyChange(PROPERTY_START_ON_DATA_INPUT, this.autoStartRecieveData, autoStartRecieveData);
		this.autoStartRecieveData = autoStartRecieveData;
	}

	public void setAutoStopRecieveData(boolean autoStopRecieveData) {

		propertyChangeSupport.firePropertyChange(PROPERTY_START_ON_DATA_INPUT, this.autoStopRecieveData, autoStopRecieveData);
		this.autoStopRecieveData = autoStopRecieveData;
	}
